...
class WxPayDataBase
{
	...
	**/
	...
	public function SetSub_Mchid($value)
	{
		$this->values['sub_mch_id'] = $value;
	}
	public function GetSub_Mchid()
	{
		return $this->values['sub_mch_id'];
	}
	public function IsSub_MchidSet()
	{
	...
	public function MakeSign()
	{
        ...
        $key = $WxPayConfig->PAY_TYPE == '1' ? $WxPayConfig->SERVICE_KEY : $WxPayConfig->APP_KEY;
