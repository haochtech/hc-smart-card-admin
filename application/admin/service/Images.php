...
class Images extends Base
{
	...
	public function addAlbumClass($aclass_name, $aclass_sort, $pid = 0, $aclass_cover = '', $is_default = 0, $mch_id)
	{
		...
		$data = array("group_name" => $aclass_name, "sort" => $aclass_sort, "group_cover" => $aclass_cover, "is_default" => $is_default, "create_time" => time(), "pid" => $pid, "ident" => '', "pages_url" => '', "is_system" => 0, "ident_class" => '', "mch_id" => $mch_id);
