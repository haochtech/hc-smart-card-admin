...
UM.ui.define('modal', {
    ...
    attachTo: function ($obj,um) {
        var me = this
        if (!$obj.data('$mergeObj')) {

            $obj.data('$mergeObj', me.root());
            $obj.on('click', function () {
                if($($obj).hasClass("edui-btn-image"))
                {
                    NOW_UM = um;
                    console.log(SSSS);
                    if(SSSS=="goods"){
                        // SSSS="";
                        art.dialog.open((UM_SITE_ROOT+'admin/images/dialogalbumlist&number=9&type=um&ss='+SSSS), {
                            lock : true,
                            title : "我的图片",
                            width : 900,
                            height : 620,
                        ...
                        layer_open("我的图片",UM_SITE_ROOT+'admin/images/dialogalbumlist&number=9&type=um',900,620);
                    }
                    return false;
                }
                else
