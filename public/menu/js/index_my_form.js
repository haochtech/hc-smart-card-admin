...
function this_checkbox_layout(val) {
    bannerVM.all_data[bannerVM.now_index]['layout']=val;
}
...
function this_radio_layout(val) {
    bannerVM.all_data[bannerVM.now_index]['layout']=val;
}
    ...
    if (form_title==''){
        layer.prompt({title: '输入表单名称',formType: 0}, function (text, index) {
            if(!lock){
                ...
                $.ajax({
                    type: "post",
                    url: host + "addons/yb_mingpian/core/index.php?s=/admin/menu/universal_form_add",
                    data: {
                    ...
                    success: function (data) {
                        if(data['code']>0 ){
                            layer.msg('成功',{icon:1,time:1000},function () {
                                load_page(host+"addons/yb_mingpian/core/index.php?s=/admin/menu/universal_form");
                            });
                        }else{
