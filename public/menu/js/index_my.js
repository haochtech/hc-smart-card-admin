...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==1){
        ...
        //右边向当前数组中增加数据
        var item = {};
        item['imgurl'] = host + "addons/yb_mingpian/core/public/menu/images/Lb2.png";
        ...
        new_item['topimg']=host + "addons/yb_mingpian/core/public/menu/images/Lb.jpg";
        new_item['list'] = arr;
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==2){
        ...
        new_item['ly_height']="3";
        new_item['juedui_height']="93";
        new_item['topimg']=host+ "addons/yb_mingpian/core/public/menu/images/Ad.jpg";
        new_item['list'] = arr;
        new_item['time_key'] = Date.parse(new Date())/1000+""+Math.round(Math.random()*100000);
        bannerVM.all_data.push(new_item);
        //获取当前增加的幻灯片下标
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==3){
        ...
        bannerVM.add_top=145;
        var item = {};
        item['imgurl'] = host+ "addons/yb_mingpian/core/public/menu/images/Lb21.png";
        item['top'] = 0;
        item['name'] = '名称';
        item['alias'] = '链接';
        ...
        new_item['topimg']=host+ "addons/yb_mingpian/core/public/menu/images/Ggdh1.png";
        new_item['list'] = arr;
        new_item['time_key'] = Date.parse(new Date())/1000+""+Math.round(Math.random()*100000);
        bannerVM.all_data.push(new_item);
        //获取当前增加的幻灯片下标
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==8){
        ...
        item['imgurl']=host+ "addons/yb_mingpian/core/public/menu/images/Tpj_3.png";
        item['top']=0;
        var arr=[];
        arr.push(item);
        //左边幻灯片增加数据
...
$("input[name='img_add_type']").click(function () {
    ...
    if (this.value==1){
        ...
        $.ajax({
            type : "post",
            url :  host+"addons/yb_mingpian/core/index.php?s=/admin/goods/get_sort_img_list",
            ...
            success : function(data) {
                ...
                if (data[0]['link']!=''){
                    item['pagesurl'] = "/yb_mingpian/pages/web/index?url="+escape(data[0]['link'])+"&name="+ data[0]['title'];
                }else {
                    item['pagesurl'] = '/yb_mingpian/pages/find_info/index?id='+data[0]['article_id'];
                }
                ...
                new_item['text_width']=bannerVM.all_data[bannerVM.now_index]['text_width'];
                new_item['style_num']=bannerVM.all_data[bannerVM.now_index]['style_num'];
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data, function(){
                ...
                if (this.link!=''){
                    item['pagesurl'] = "/yb_mingpian/pages/web/index?url="+escape(this.link)+"&name="+ this.title;
                }else {
                    item['pagesurl'] = '/yb_mingpian/pages/find_info/index?id='+this.article_id;
                }
...
$("input[name='goods_add_type']").click(function () {
    ...
    if (this.value==1){
        ...
        $.ajax({
            type : "post",
            url :  host+"addons/yb_mingpian/core/index.php?s=/admin/goods/get_sort_list",
            data : {'num':num,'sort':'time'},
            success : function(data) {
                var item = {};
                item['this_type']="goods";
                ...
                item['pagesurl'] = '/yb_mingpian/pages/goods/detail/index?id='+data[0]['goods_id'];
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data, function(){
                ...
                item['top'] = bannerVM.goodlist.length * 135;
                item['pagesurl'] = '/yb_mingpian/pages/goods/detail/index?id='+this.goods_id;
...
//名称
function this_productlist_name(obj,name) {
    var index=$(obj).attr("data-index");
    bannerVM.all_data[bannerVM.now_index]['list'][index]['name']=name;
}
//简介
function this_productlist_description(obj,content) {
    var index=$(obj).attr("data-index");
    bannerVM.all_data[bannerVM.now_index]['list'][index]['content']=content;
}
$("input[name='componentLayoutRadio']").click(function () {
    bannerVM.all_data[bannerVM.now_index]['layout'] = this.value;
})
...
//*********************************************产品集star*************************************************//
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==1001){
        $("#product_list").css("display",'block').siblings().css("display",'none');
        bannerVM.add_h=245;
        bannerVM.add_top=145;
        var item = {};
        item['this_type']="product";
        item['name']="标题";
        item['content']="产品简介";
        item['price']="9.9";
        item['key_id']="";
        item['pic']=host+ "addons/yb_mingpian/core/public/menu/images/Tpj_3.png";
        item['top']=0;
        var arr=[];
        arr.push(item);
        //左边幻灯片增加数据
        ...
        bannerVM.now_index = bannerVM.all_data.length-1;
        //右边当前数组=左侧当前幻灯片下标
        bannerVM.products=bannerVM.all_data[bannerVM.now_index]['list'];
    }
})
//添加一条空数据
function product_add_menu() {
    var item = {};
    item['this_type']="product";
    item['name']="标题";
    item['price']="9.9";
    ...
    item['content']="产品简介";
    item['pic']=host+ "addons/yb_mingpian/core/public/menu/images/Tpj_3.png";
    item['top'] = bannerVM.products.length * 135;
    bannerVM.add_h += 135;
    bannerVM.add_top += 135;
    bannerVM.products.push(item);
}
//字体大小
$("input[name='productfontsize_zt']").click(function () {
    bannerVM.all_data[bannerVM.now_index]['title_size']=this.value;
    $(this).parent().addClass("selected").siblings().removeClass("selected");
})
//字体颜色
function product_font_color(color) {
    bannerVM.all_data[bannerVM.now_index]['title_color']=color;
    $("#product_color_text").html(color);
}
//名称
function this_productlist_name(obj,name) {
    var index=$(obj).attr("data-index");
...
//简介
function this_productlist_content(obj,content) {
    var index=$(obj).attr("data-index");
    bannerVM.all_data[bannerVM.now_index]['list'][index]['content']=content;
}
$("input[name='componentLayoutRadio']").click(function () {
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==10){
        ...
        item['imgurl']=host+ "addons/yb_mingpian/core/public/menu/images/kefu.png";//显示图片
        item['name']='点击选择链接';
        var arr=[];
        arr.push(item);
        //左边幻灯片增加数据
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==13){
        ...
        item['imgurl'] = host+ "addons/yb_mingpian/core/public/menu/images/Tplb_3.png";
        item['top'] = 0;
        item['title'] = '标题';
        item['name'] = '链接至';
        var arr=[];
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==24){
        ...
        new_item['imgurl'] = host+ "addons/yb_mingpian/core/public/menu/images/service_icon.png";
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==25){
        ...
        new_item['form_transparent']="1";
        new_item['form_icon_transparent']="1";
        new_item['imgurl'] = host+ "addons/yb_mingpian/core/public/menu/images/tel_icon.png";
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==14){
        ...
        item['imgurl'] = host+ "addons/yb_mingpian/core/public/menu/images/kefu.png";
        item['name']="点击选择链接";
        var arr=[];
        arr.push(item);
        //左边幻灯片增加数据
...
//字体大小
$("input[name='vidoe_url']").click(function () {
    bannerVM.all_data[bannerVM.now_index]['video_type']=this.value;
});
//*********************************************视频end*************************************************//
//*********************************************评论star*************************************************//
$(".j-diy-addModule").click(function () {
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==19){
        ...
        item['img']=host+ "addons/yb_mingpian/core/public/menu/images/11red.PNG";
        item['top'] =0;
        var item1 = {};
        item1['this_type']="tripartite";
        item1['img']=host+ "addons/yb_mingpian/core/public/menu/images/21blue.PNG";
        item1['top'] = 135;
        var item2 = {};
        item2['this_type']="tripartite";
        item2['img']=host+ "addons/yb_mingpian/core/public/menu/images/21yellow.PNG";
        item2['top'] = 270;
        var arr=[];
        arr.push(item);
        arr.push(item1);
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==20){
        ...
        item['img']=host+ "addons/yb_mingpian/core/public/menu/images/23blue.PNG";
        item['top'] =0;
        var item1 = {};
        item1['this_type']="quartet";
        item1['img']=host+ "addons/yb_mingpian/core/public/menu/images/11blue.PNG";
        item1['top'] = 135;
        var item2 = {};
        item2['this_type']="quartet";
        item2['img']=host+ "addons/yb_mingpian/core/public/menu/images/11red.PNG";
        item2['top'] = 270;
        var item3 = {};
        item3['this_type']="quartet";
        item3['img']=host+ "addons/yb_mingpian/core/public/menu/images/11yellow.PNG";
        item3['top'] = 405;
        var arr=[];
        arr.push(item);
        arr.push(item1);
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==26){
        ...
        new_item['imgurl'] = host+ "addons/yb_mingpian/core/public/menu/images/hotdot.png";
        new_item['bg_color']="#ffffff";
        new_item['color']="#000000";
        new_item['title']="";
        new_item['time_key'] = Date.parse(new Date())/1000+""+Math.round(Math.random()*100000);
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==27){
        ...
        //左边幻灯片增加数据
        var new_item ={};
        new_item['img']=host+ "addons/yb_mingpian/core/public/menu/images/tencent_app.jpg";
        new_item['type']="ad";
        new_item['ad_id']="0";
        new_item['height']="140";
        new_item['time_key'] = Date.parse(new Date())/1000+""+Math.round(Math.random()*100000);
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==22){
        ...
        new_item['door_phone']="";
        new_item['imgurl']=host+ "addons/yb_mingpian/core/public/menu/images/business.png";
        new_item['time_key'] = Date.parse(new Date())/1000+""+Math.round(Math.random()*100000);
        bannerVM.all_data.push(new_item);
        bannerVM.now_index = bannerVM.all_data.length-1;
    }
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==99){
        ...
        //左边幻灯片增加数据
        var new_item ={};
        new_item['type']="join_us";
        new_item['list']=arr;
        new_item['time_key'] = Date.parse(new Date())/1000+""+Math.round(Math.random()*100000);
        bannerVM.all_data.push(new_item);
        bannerVM.now_index = bannerVM.all_data.length-1;
        bannerVM.joinlist=bannerVM.all_data[bannerVM.now_index]['list'];
    }
})
function add_join() {
    var item = {};
    ...
    item['key_id']="";
    item['exp']="无";
    item['top'] = bannerVM.joinlist.length * 135;
    bannerVM.add_h += 135;
    bannerVM.add_top += 135;
    bannerVM.joinlist.push(item);
}
//*********************************************留言板*************************************************//
//*********************************************表单star*************************************************//
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==23){
        ...
        new_item['imgurl']=host+ "addons/yb_mingpian/core/public/menu/images/choose_form.jpg";
        new_item['param']="0";
        new_item['time_key'] = Date.parse(new Date())/1000+""+Math.round(Math.random()*100000);
        bannerVM.all_data.push(new_item);
        bannerVM.now_index = bannerVM.all_data.length-1;
...
function get_not_attr(index,item) {
    ...
    new_item['pagesurl']= removeAllSpace("/yb_mingpian/"+item['imgurl']);
...
function get_images(index,item,a,b,c,this_index) {
    ...
    if (item['type']=='applets'){
        ...
        if (typeof(item['imgurl'])!="undefined"){
            new_item['pagesurl'] = removeAllSpace("/yb_mingpian/"+a+"/"+b+"/"+c+"?id="+item['param']);
        }
        if (typeof(item['link'])!="undefined"&&item['link']!=''){
            new_item['pagesurl'] = "/yb_mingpian/pages/web/index?url="+escape(item['link'])+"&name="+ item['name'];
        }
        new_item['key'] = 1;
        new_item['name'] = item['name'];
    ...
    if (item['type']=="join"){
        new_item['name'] = item['name'];
        new_item['pay'] = item['pay'];
        new_item['exp'] =item['exp'];
        new_item['major'] =item['major'];
        new_item['key_id'] = item['key_id'];
        Vue.set(bannerVM.joinlist,this_index,new_item);
    }
    if (item['type']=="product"){
        new_item['name'] = item['name'];
        new_item['content'] = item['content'];
        new_item['pic'] = item['pic'];
        new_item['price'] = item['price'];
        new_item['key_id'] = item['key_id'];
        Vue.set(bannerVM.products,this_index,new_item);
    }
}
//保存
$("#saveButon").click(function () {
    ...
    $.ajax({
        type : "post",
        url : host+"addons/yb_mingpian/core/index.php?s=/admin/menu/index_module",
        data : {
